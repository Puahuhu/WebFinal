                                ...
                                employs.forEach(function (employ) {
                                    if (employ.UserID === userId) {
                                        ...
                                        $(".home-text").append(
                                            ...
                                            "</div>" +
                                            "<div class='main-btn'>" +
                                            "<a href='../../salesperson/Report/SalesSalesDetails.php' class='btn2 sidebar-link'> Sales Details</a>" +
                                            "</div>"
                                        );
                                        ...
                                        $(".sidebar-link[href='../../salesperson/Report/SalesSalesDetails.php']").attr("href", "../../salesperson/Report/SalesSalesDetails.php?username=" + encodeURIComponent(username));
