                                ...
                                adms.forEach(function (adm) {
                                    if (adm.UserID === userId) {
                                        $(".user-wrapper").append(
                                            ...
                                            "<a><div><h4 class='yellow text-hover1'>" + adm.FullName + "</h4><small> Salesperson </small></div></a>"
                                        );
                                    }
                                });
                            } else {
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <main class="scrollable-content">
                ...
                <div class="home">
                    <div class="home-text">
                        <form id="invoiceForm" method="post" action="ReceiptDetails_Sales.php?username=<?php echo urlencode($_GET['username']); ?>">
