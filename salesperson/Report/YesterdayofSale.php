...
<script>
    ...
    function redirectToCustomerDetails(ProductID) {
        ...
        window.location.href = 'ReceiptDetailSales.php?ProductID=' + ProductID + '&username=' +encodeURIComponent(username) ;
    }
</script>
            ...
            <main>
                ...
                <div class="cards1">
                    <div class="card-single5 hover-button">
                        <a href="SalesReport.php?username=<?php echo urlencode($_GET['username']); ?>"  class="sidebar-link"> <button>Today</button></a>
                    </div>
                    <div class="card-single5 active-button">
                        <a href="YesterdayofSale.php?username=<?php echo urlencode($_GET['username']); ?>"  class="sidebar-link"> <button>Yesterday</button></a>
                    </div>
                    <div class="card-single5 hover-button">
                        <a href="SaleTheLastSevenDays.php?username=<?php echo urlencode($_GET['username']); ?>"  class="sidebar-link"> <button>The last 7 days</button></a>
                    </div>
                    <div class="card-single5 hover-button">
                        <a href="ThisMonthOfSales.php?username=<?php echo urlencode($_GET['username']); ?>"  class="sidebar-link"> <button>This month</button></a>
                    </div>
                    <div class="card-single5 hover-button">
                        <a href="FromToOfSales.php?username=<?php echo urlencode($_GET['username']); ?>" class="sidebar-link"> <button>From-To</button></a>
                    </div>
                </div>
                <div class="cards">
                ...
                <?php 
                        ...
                        WHERE DATE(orders.OrderDate) = '$yesterday'";
