    ...
    if (empty($username)) {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                header("Location: ../admin/AccMana/AccountManagement.php?username=$username");
                exit();
            } else {
...
<body>
        ...
        <div class="inner">
            ...
            <form action="AdminLogin.php" method="post" id="loginForm">
                <div class="form-button">
                    <button class="active">Admin
                        <i class="zmdi zmdi-account"></i>
                    </button>
                    <button class="choose" id="salesButton">Salesperson
                        <i class="zmdi zmdi-account"></i>
                    </button>
                </div>
                <h3>Sign in</h3>
    ...
    <script>
        document.getElementById("salesButton").addEventListener("click", function () {
            document.getElementById("loginForm").action = "SalesLogin.php";
        });
    </script>
</body>
</html>
